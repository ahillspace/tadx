...
func (o Output) CompactOutput() any {
	return CompactResult{Profile: CompactProfile{Alias: o.Profile.Alias, Default: o.Profile.Default, ServerURL: o.Profile.ServerURL, SiteContentURL: o.Profile.SiteContentURL}, Details: "--full", Help: o.Help}
}

...
func (a *Action) Execute(ctx context.Context, input Input) (Output, error) {
	...
	if err != nil {
		return Output{}, &errs.Error{ID: "workbook.resolve.failed", Kind: errs.KindOperation, Operation: "workbook.pull", Environment: input.Environment, Site: input.Site, Summary: "Workbook resolution failed.", Cause: err, Retryable: errs.Bool(false), TableauRequestID: errs.TableauRequestID(err)}
	}
	...
	if err != nil {
		...
		return Output{}, &errs.Error{ID: "workbook.download.failed", Kind: errs.KindOperation, Operation: "workbook.pull", Resource: workbook.LUID, Environment: input.Environment, Site: input.Site, Summary: "Workbook download failed.", Cause: err, Retryable: errs.Bool(false), TableauRequestID: requestID}
	}

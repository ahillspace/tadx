...
func (a *Action) Execute(ctx context.Context, input Input) (Output, error) {
	...
	return Output{Status: "pulled", Workbook: workbook, Artifact: artifact, Warnings: warnings, RequestID: download.TableauRequestID, Help: []string{commandhint.Target(input.Environment, input.WorkspaceName, "content", "workbook", "publish", "--artifact", artifact.Path, "--project-id", workbook.ProjectLUID, "--overwrite", "--preview")}}, nil
}

...
func (o PublishOutput) CompactOutput() any {
	...
	if o.Result != nil {
		result = &PublishCompactPublishResult{Status: o.Result.Status, FlowLUID: o.Result.FlowLUID, FlowName: o.Result.FlowName, ProjectLUID: o.Result.ProjectLUID, ReceiptPath: o.Result.ReceiptPath, Verification: o.Result.Verification}
	}
	plan := &PublishCompactPlan{Workspace: o.Plan.Workspace, Kind: "flow", SourceLUID: o.Plan.SourceLUID, Mode: o.Plan.Mode, Operation: o.Plan.Operation, FlowName: o.Plan.FlowName, Target: o.Plan.Target, Overwrite: o.Plan.Overwrite, ArtifactPath: o.Plan.ArtifactPath, SourceKind: o.Plan.SourceKind}

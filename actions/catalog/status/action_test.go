...
import (
	...
	status "github.com/ahillspace/tadx/actions/catalog/status"
...
func TestActionCompactAndFullOutput(t *testing.T) {
	action := status.New(source{result: status.Result{ID: "generation-1", Environment: "production", Site: "marketing", GeneratedAt: "2026-09-01T00:00:00Z", Age: "13h0m0s", Complete: true, Stale: true, Source: "tableau-rest", Path: "catalog/production.json", Records: 2, Warnings: []string{"catalog generation is older than 12 hours"}}})

...
func (a *Action) Plan(ctx context.Context, in Input) (Plan, error) {
	...
	return Plan{Mode: "preview", Operation: "admin.group.member.remove", Environment: in.Environment, Site: in.Site, GroupLUID: group.LUID, GroupName: group.Name, UserLUID: in.UserLUID, NoOp: !contains(group.Members, in.UserLUID), planned: true}, nil
}

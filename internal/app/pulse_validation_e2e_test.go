...
func TestPulseCreateValidationThroughCLI(t *testing.T) {
	for _, test := range []struct {
		...
		{name: "ambiguous count", measure: "Duplicate ID", aggregation: "COUNT", dimensions: []string{"Region"}, wantError: "matched 2 fields"},
		{name: "unknown count", measure: "Missing ID", aggregation: "COUNT", dimensions: []string{"Region"}, wantError: "matched 0 fields"},
